...
Isadmin=$(curl -sS https://raw.githubusercontent.com/arlanstore4/ip/main/access | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/arlanstore4/ip/main/access | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/arlanstore4/update/main/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/arlanstore4/ip/main/versi)
...
serverV=$( curl -sS https://raw.githubusercontent.com/arlanstore4/ip/main/versi)
if [ "$Isadmin" = "ON" ]; then
